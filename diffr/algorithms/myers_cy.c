 ...
 *             continue
 */
    __pyx_t_5 = (__pyx_v_ch == 32);
    if (!__pyx_t_5) {
    } else {
      __pyx_t_3 = __pyx_t_5;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_5 = (9 <= __pyx_v_ch);
    if (__pyx_t_5) {
      __pyx_t_5 = (__pyx_v_ch <= 13);
    }
    __pyx_t_3 = __pyx_t_5;
 ...
 *             while i < n:
 */
    __pyx_t_5 = (48 <= __pyx_v_ch);
    if (__pyx_t_5) {
      __pyx_t_5 = (__pyx_v_ch <= 57);
    }
    if (!__pyx_t_5) {
    } else {
      __pyx_t_3 = __pyx_t_5;
    ...
    __pyx_t_5 = (65 <= __pyx_v_ch);
    if (__pyx_t_5) {
      __pyx_t_5 = (__pyx_v_ch <= 90);
    }
    if (!__pyx_t_5) {
    } else {
      __pyx_t_3 = __pyx_t_5;
    ...
    __pyx_t_5 = (97 <= __pyx_v_ch);
    if (__pyx_t_5) {
      __pyx_t_5 = (__pyx_v_ch <= 0x7A);
    }
    if (!__pyx_t_5) {
    } else {
      __pyx_t_3 = __pyx_t_5;
...
static PyObject *__pyx_f_5diffr_10algorithms_8myers_cy__backtrack_fast(PyObject *__pyx_v_words1, PyObject *__pyx_v_words2, PyObject *__pyx_v_trace, int __pyx_v_offset, Py_ssize_t __pyx_v_size) {
  ...
  int __pyx_v_idx;
  PyObject *__pyx_v_tag_equal = 0;
  PyObject *__pyx_v_tag_insert = 0;
  PyObject *__pyx_v_tag_delete = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_v_tag_equal);
  __Pyx_XDECREF(__pyx_v_tag_insert);
  __Pyx_XDECREF(__pyx_v_tag_delete);
